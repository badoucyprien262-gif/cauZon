  ...
  const gererConnexionGoogle = async () => {
    try {
      ...
      const currentOrigin = (typeof window !== 'undefined' && window.location?.origin)
        ...
        : undefined;
      await connexionGoogle(currentOrigin);
    } catch (err) {
      console.warn('Erreur connexion Google Auth Wall :', err);
    } finally {
            ...
            {enCoursConnexion ? (
              ...
              <>
                <View style={styles.googleIconCircle}>
                  {Platform.OS === 'web' ? (
                    <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' } as any}>
